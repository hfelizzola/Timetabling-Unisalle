...
$CALL GDXXRW chiqui2.xlsx par=CFM rng=CFM!A1:CN67 Rdim=2 Cdim=1
$GDXIN chiqui2.gdx
$LOAD CFM
$GDXIN
...
$CALL GDXXRW chiqui2.xlsx par=MP rng=MP!A1:AE91 Cdim=1 Rdim=1
$GDXIN chiqui2.gdx
$LOAD MP
$gdxIn
...
parameter FP(n,i,k);
*Matriz de 1 y O si en la franja i en el dia n esta disponible el profesor k
$CALL GDXXRW chiqui2.xlsx par=FP rng=FP!A1:AF67 Rdim=2 Cdim=1
$GDXIN chiqui2.gdx
$LOAD FP
$GDXIN
...
Parameter MS(j,m);
*Matriz de 1 y 0 1 si la materia j pertenece al semestre m 0 sino
$CALL GDXXRW chiqui2.xlsx par=MS rng=MS!A1:L91 Cdim=1 Rdim=1
$GDXIN chiqui2.gdx
$LOAD MS
$gdxIn
...
$CALL GDXXRW chiqui2.xlsx par=INTH rng=INTH!A1:B90 Cdim=0 Rdim=1
$GDXIN chiqui2.gdx
$LOAD INTH
$gdxIn
...
Parameter PMAX(K)
*Numero de horas que debe tener la materia j
$CALL GDXXRW chiqui2.xlsx par=PMAX rng=PMAX!A1:B30 Cdim=0 Rdim=1
$GDXIN chiqui2.gdx
$LOAD PMAX
$gdxIn
...
Parameter PMIN(K)
*Numero de horas que debe tener la materia j
$CALL GDXXRW chiqui2.xlsx par=PMIN rng=PMIN!A1:B30 Cdim=0 Rdim=1
$GDXIN chiqui2.gdx
$LOAD PMIN
$gdxIn
...
Parameter DOSF(J)
*Numero de horas que debe tener la materia j
$CALL GDXXRW chiqui2.xlsx par=DOSF rng=DOSF!A1:B90 Cdim=0 Rdim=1
$GDXIN chiqui2.gdx
$LOAD DOSF
$gdxIn
...
Parameter TRESF(J)
*Numero de horas que debe tener la materia j
$CALL GDXXRW chiqui2.xlsx par=TRESF rng=TRESF!A1:B90 Cdim=0 Rdim=1
$GDXIN chiqui2.gdx
$LOAD TRESF
$gdxIn
